...
extension NoteQueryLinks on QueryBuilder<Note, Note, QFilterCondition> {
  QueryBuilder<Note, Note, QAfterFilterCondition> diary(FilterQuery<Diary> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'diary');
    });
  }

  QueryBuilder<Note, Note, QAfterFilterCondition> diaryIsNull() {
    return QueryBuilder.apply(this, (query) {
